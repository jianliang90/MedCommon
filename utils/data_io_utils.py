...
class DataIO(object):
    ...
    @staticmethod
    def save_medical_info_and_data(image_array, origin, spacing, direction, save_path):
    ...
    @staticmethod
    def save_medical_image(image_array, save_path):
    ...
    @staticmethod
    def mask_array_to_sitk(mask_array, data_info, label=7, sitk_type=sitk.sitkUInt8):
    ...
    @staticmethod
    def save_mask_compress(ori_path, dest_path):
        """Save mask compress"""
        """
        Args:
