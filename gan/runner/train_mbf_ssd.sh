...
# --use_env \
# train_gan_3d.py \
# --dataroot /ssd/zhangwd/cta2mbf/data_yourname/5.mbf_myocardium \
# --model pix2pix_3d \
# --input_nc 1 \
# --output_nc 1 \
# --ngf 32 \
...
# --lr_policy cosine \
# --lr 1e-4 \
# --checkpoints_dir /ssd/zhangwd/cta2mbf/data_yourname/checkpoints \
# --name cta2mbf_sr \
# --crop_size 384 384 160 \
# --dst_vis_lut jet \
# --src_pattern cropped_cta.nii.gz \
...
# for inference
CUDA_VISIBLE_DEVICES=3 python train_gan_3d.py \
--dataroot /ssd/zhangwd/cta2mbf/data_yourname/5.mbf_myocardium \
--model pix2pix_3d \
--input_nc 1 \
--output_nc 1 \
