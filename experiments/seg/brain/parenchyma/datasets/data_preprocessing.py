...
def generate_ds():
    generate_resampled_pairs_unsame_resolution(
        '/data/medical/brain/cerebral_parenchyma/exp/cta', 
        '/data/medical/brain/cerebral_parenchyma/exp/ct_256', 
        [256,256,256]
    )
    generate_resampled_pairs_unsame_resolution(
        '/data/medical/brain/cerebral_parenchyma/exp/ncct', 
        '/data/medical/brain/cerebral_parenchyma/exp/ct_256', 
        [256,256,256]
    )
...
# 划分数据集
def split_ds():
    image_root = '/data/medical/brain/cerebral_parenchyma/exp/ct_256/images'
    out_config_dir = '/data/medical/brain/cerebral_parenchyma/exp/ct_256/config'
